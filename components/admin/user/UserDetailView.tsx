              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-950/50 rounded-2xl border border-gray-800/50">
                  ...
                  <span className={`px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wider ${
                    role === 'admin' ? 'bg-purple-500/20 text-purple-400 border border-purple-500/20' :
                    role === 'operator' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/20' :
                ...
                <div className="p-4 bg-gray-950/50 rounded-2xl border border-gray-800/50">
                  ...
                  <span className={`px-2 py-0.5 rounded-md text-[10px] font-black uppercase tracking-wider ${
                    disabled ? 'bg-red-500/20 text-red-400 border border-red-500/20' : 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/20'
                  }`}>
