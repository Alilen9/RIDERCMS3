...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'rental', label: 'Battery Rentals', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  { id: 'cleanup', label: 'Session Cleanup', icon: 'M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16' },
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ activeSection, onNavigate, isOpen, onClose, onLogout }) => {
  ...
  return (
    <>
      ...
      <aside className={`w-64 bg-gray-900 border-r border-gray-800 flex-col fixed h-full z-30 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'} flex`}>
        ...
        <div className="p-4 border-t border-gray-800 space-y-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-gray-300 py-2 rounded-lg transition-colors text-sm font-bold"
          >
